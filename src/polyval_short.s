...
; Fused XOR: dst = op_a XOR op_b (16 bytes, three distinct abs regions).
; NB: ca65 reserves the bare identifier `a` for accumulator addressing
; mode, so macro params must use non-register names.
.macro pv_xor_htable_entries op_a, op_b, dst
        lda op_a+0
        eor op_b+0
        sta dst+0
        lda op_a+1
...
@copy_h:
        ...
        lda polyval_acc+0
        sta polyval_htable+16
        lda polyval_acc+1
        sta polyval_htable+17
        lda polyval_acc+2
        sta polyval_htable+18
        lda polyval_acc+3
        sta polyval_htable+19
        lda polyval_acc+4
        sta polyval_htable+20
        lda polyval_acc+5
        sta polyval_htable+21
        lda polyval_acc+6
        sta polyval_htable+22
        lda polyval_acc+7
        sta polyval_htable+23
        lda polyval_acc+8
        sta polyval_htable+24
        lda polyval_acc+9
        sta polyval_htable+25
        lda polyval_acc+10
        sta polyval_htable+26
        lda polyval_acc+11
        sta polyval_htable+27
        lda polyval_acc+12
        sta polyval_htable+28
        lda polyval_acc+13
        sta polyval_htable+29
        lda polyval_acc+14
        sta polyval_htable+30
        lda polyval_acc+15
        sta polyval_htable+31
