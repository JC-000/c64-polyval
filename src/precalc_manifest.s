...
; the AEAD archives (polyval.a / polyval-gcmsiv.a /
; polyval-gcmsiv-short.a / polyval-gcmsiv-compact.a) and the full-app /
; lib-verify links only. The POLYVAL-only archives (polyval-long.a /
; polyval-short.a / polyval-compact.a) omit tables.o, so their
; manifests must not describe
...
; at PROFILE=long -- so the lib-polyval-{long,short,compact} Makefile targets
