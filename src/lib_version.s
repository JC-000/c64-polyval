...
;
; The LIB_VERSION_* and LIB_ABI_VERSION symbols intentionally carry no
; library prefix: per the contract every adopter library exports the
; same four names, so a consumer that vendors multiple libraries
; imports them under disambiguating aliases (or in separate scopes).
; =============================================================================
