; =============================================================================
; lib/tables.s - AES S-box (256B), inverse S-box (256B), round constants (10B)
;
; ca65 port of src/lib/tables.asm. Lives in RODATA; not page-aligned — the
; ACME original isn't either (only the Shoup htables require page alignment,
; and those live in their own segments in data.s).
; =============================================================================
