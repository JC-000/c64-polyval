; =============================================================================
; disk_io.s - Disk I/O helpers: input, filename mgmt, hex conversion
;             (ca65 port of disk_io.asm)
; =============================================================================
...
.import filename_buf
.import input_index
.import actual_filename
.import default_gcm_filename
.import filename_len
...
.import key_read_buf
.import disk_error_code
.import drive_number
.import aes_current_key

.export get_input_line
.export copy_input_to_filename
.export set_default_filename
.export increment_filename
.export print_filename
.export check_file_exists
.export check_disk_error
.export write_hex_digit
.export read_hex_char
.export build_write_filename
.export build_read_filename
.export verify_key_match
