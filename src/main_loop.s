; =============================================================================
; main_loop.s - Main menu dispatcher (ca65 port of main_loop.asm)
; =============================================================================

.include "constants_app.inc"

.import do_gcm_siv_encrypt
.import do_gcm_siv_decrypt
.import do_save_gcm_siv
.import do_load_gcm_siv
.import print_string
.import exit_msg
