...
; happens before any code, the equates are resolved and ZP encoding is
; chosen. No .importzp needed here.

; Absolute (non-ZP) symbols from data.s.
.import polyval_h
.import polyval_temp
.import polyval_htable
.import polyval_htable8
.import polyval_htable8_s0, polyval_htable8_s1, polyval_htable8_s2, polyval_htable8_s3
.import polyval_htable8_s4, polyval_htable8_s5, polyval_htable8_s6, polyval_htable8_s7
.import polyval_htable8_s8, polyval_htable8_s9, polyval_htable8_s10, polyval_htable8_s11
.import polyval_htable8_s12, polyval_htable8_s13, polyval_htable8_s14, polyval_htable8_s15
.import polyval_reduce8
.import polyval_reduce8_s0, polyval_reduce8_s1, polyval_reduce8_s2, polyval_reduce8_s3
.import polyval_reduce8_s4, polyval_reduce8_s5, polyval_reduce8_s6, polyval_reduce8_s7
.import polyval_reduce8_s8, polyval_reduce8_s9, polyval_reduce8_s10, polyval_reduce8_s11
.import polyval_reduce8_s12, polyval_reduce8_s13, polyval_reduce8_s14, polyval_reduce8_s15
...
.macro pv_unroll_xor_htable_16
        lda polyval_acc+0
        eor polyval_htable+0,y
        sta polyval_acc+0
        lda polyval_acc+1
        eor polyval_htable+1,y
        sta polyval_acc+1
        lda polyval_acc+2
        eor polyval_htable+2,y
        sta polyval_acc+2
        lda polyval_acc+3
        eor polyval_htable+3,y
        sta polyval_acc+3
        lda polyval_acc+4
        eor polyval_htable+4,y
        sta polyval_acc+4
        lda polyval_acc+5
        eor polyval_htable+5,y
        sta polyval_acc+5
        lda polyval_acc+6
        eor polyval_htable+6,y
        sta polyval_acc+6
        lda polyval_acc+7
        eor polyval_htable+7,y
        sta polyval_acc+7
        lda polyval_acc+8
        eor polyval_htable+8,y
        sta polyval_acc+8
        lda polyval_acc+9
        eor polyval_htable+9,y
        sta polyval_acc+9
        lda polyval_acc+10
        eor polyval_htable+10,y
        sta polyval_acc+10
        lda polyval_acc+11
        eor polyval_htable+11,y
        sta polyval_acc+11
        lda polyval_acc+12
        eor polyval_htable+12,y
        sta polyval_acc+12
        lda polyval_acc+13
        eor polyval_htable+13,y
        sta polyval_acc+13
        lda polyval_acc+14
        eor polyval_htable+14,y
        sta polyval_acc+14
        lda polyval_acc+15
        eor polyval_htable+15,y
        sta polyval_acc+15
.endmacro
...
; sparse-polynomial reduction. Uses ca65 unnamed forward labels (`:`)
...
.macro pv_store_acc_to_htable8_x
        lda polyval_acc+0
        sta polyval_htable8_s0,x
        lda polyval_acc+1
        sta polyval_htable8_s1,x
        lda polyval_acc+2
        sta polyval_htable8_s2,x
        lda polyval_acc+3
        sta polyval_htable8_s3,x
        lda polyval_acc+4
        sta polyval_htable8_s4,x
        lda polyval_acc+5
        sta polyval_htable8_s5,x
        lda polyval_acc+6
        sta polyval_htable8_s6,x
        lda polyval_acc+7
        sta polyval_htable8_s7,x
        lda polyval_acc+8
        sta polyval_htable8_s8,x
        lda polyval_acc+9
        sta polyval_htable8_s9,x
        lda polyval_acc+10
        sta polyval_htable8_s10,x
        lda polyval_acc+11
        sta polyval_htable8_s11,x
        lda polyval_acc+12
        sta polyval_htable8_s12,x
        lda polyval_acc+13
        sta polyval_htable8_s13,x
        lda polyval_acc+14
        sta polyval_htable8_s14,x
        lda polyval_acc+15
        sta polyval_htable8_s15,x
.endmacro

; Load polyval_acc <- sliced table entry at index X (for htable8).
.macro pv_load_acc_from_htable8_x
        lda polyval_htable8_s0,x
        sta polyval_acc+0
        lda polyval_htable8_s1,x
        sta polyval_acc+1
        lda polyval_htable8_s2,x
        sta polyval_acc+2
        lda polyval_htable8_s3,x
        sta polyval_acc+3
        lda polyval_htable8_s4,x
        sta polyval_acc+4
        lda polyval_htable8_s5,x
        sta polyval_acc+5
        lda polyval_htable8_s6,x
        sta polyval_acc+6
        lda polyval_htable8_s7,x
        sta polyval_acc+7
        lda polyval_htable8_s8,x
        sta polyval_acc+8
        lda polyval_htable8_s9,x
        sta polyval_acc+9
        lda polyval_htable8_s10,x
        sta polyval_acc+10
        lda polyval_htable8_s11,x
        sta polyval_acc+11
        lda polyval_htable8_s12,x
        sta polyval_acc+12
        lda polyval_htable8_s13,x
        sta polyval_acc+13
        lda polyval_htable8_s14,x
        sta polyval_acc+14
        lda polyval_htable8_s15,x
        sta polyval_acc+15
.endmacro
...
.macro pv_store_acc_to_reduce8_x
        lda polyval_acc+0
        sta polyval_reduce8_s0,x
        lda polyval_acc+1
        sta polyval_reduce8_s1,x
        lda polyval_acc+2
        sta polyval_reduce8_s2,x
        lda polyval_acc+3
        sta polyval_reduce8_s3,x
        lda polyval_acc+4
        sta polyval_reduce8_s4,x
        lda polyval_acc+5
        sta polyval_reduce8_s5,x
        lda polyval_acc+6
        sta polyval_reduce8_s6,x
        lda polyval_acc+7
        sta polyval_reduce8_s7,x
        lda polyval_acc+8
        sta polyval_reduce8_s8,x
        lda polyval_acc+9
        sta polyval_reduce8_s9,x
        lda polyval_acc+10
        sta polyval_reduce8_s10,x
        lda polyval_acc+11
        sta polyval_reduce8_s11,x
        lda polyval_acc+12
        sta polyval_reduce8_s12,x
        lda polyval_acc+13
        sta polyval_reduce8_s13,x
        lda polyval_acc+14
        sta polyval_reduce8_s14,x
        lda polyval_acc+15
        sta polyval_reduce8_s15,x
.endmacro

; Load polyval_acc <- sliced reduce8 entry at index X.
.macro pv_load_acc_from_reduce8_x
        lda polyval_reduce8_s0,x
        sta polyval_acc+0
        lda polyval_reduce8_s1,x
        sta polyval_acc+1
        lda polyval_reduce8_s2,x
        sta polyval_acc+2
        lda polyval_reduce8_s3,x
        sta polyval_acc+3
        lda polyval_reduce8_s4,x
        sta polyval_acc+4
        lda polyval_reduce8_s5,x
        sta polyval_acc+5
        lda polyval_reduce8_s6,x
        sta polyval_acc+6
        lda polyval_reduce8_s7,x
        sta polyval_acc+7
        lda polyval_reduce8_s8,x
        sta polyval_acc+8
        lda polyval_reduce8_s9,x
        sta polyval_acc+9
        lda polyval_reduce8_s10,x
        sta polyval_acc+10
        lda polyval_reduce8_s11,x
        sta polyval_acc+11
        lda polyval_reduce8_s12,x
        sta polyval_acc+12
        lda polyval_reduce8_s13,x
        sta polyval_acc+13
        lda polyval_reduce8_s14,x
        sta polyval_acc+14
        lda polyval_reduce8_s15,x
        sta polyval_acc+15
.endmacro
...
.macro pv_inline_shift_left_8
        ...
        lda polyval_acc+0
        eor polyval_reduce8_s0,x
        sta polyval_acc+0
        lda polyval_acc+1
        eor polyval_reduce8_s1,x
        sta polyval_acc+1
        lda polyval_acc+2
        eor polyval_reduce8_s2,x
        sta polyval_acc+2
        lda polyval_acc+3
        eor polyval_reduce8_s3,x
        sta polyval_acc+3
        lda polyval_acc+4
        eor polyval_reduce8_s4,x
        sta polyval_acc+4
        lda polyval_acc+5
        eor polyval_reduce8_s5,x
        sta polyval_acc+5
        lda polyval_acc+6
        eor polyval_reduce8_s6,x
        sta polyval_acc+6
        lda polyval_acc+7
        eor polyval_reduce8_s7,x
        sta polyval_acc+7
        lda polyval_acc+8
        eor polyval_reduce8_s8,x
        sta polyval_acc+8
        lda polyval_acc+9
        eor polyval_reduce8_s9,x
        sta polyval_acc+9
        lda polyval_acc+10
        eor polyval_reduce8_s10,x
        sta polyval_acc+10
        lda polyval_acc+11
        eor polyval_reduce8_s11,x
        sta polyval_acc+11
        lda polyval_acc+12
        eor polyval_reduce8_s12,x
        sta polyval_acc+12
        lda polyval_acc+13
        eor polyval_reduce8_s13,x
        sta polyval_acc+13
        lda polyval_acc+14
        eor polyval_reduce8_s14,x
        sta polyval_acc+14
        lda polyval_acc+15
        eor polyval_reduce8_s15,x
        sta polyval_acc+15
.endmacro
...
.macro pv_fused_shift_reduce_htable
        lda polyval_acc+14
        eor polyval_reduce8_s15,x
        eor polyval_htable8_s15,y
        sta polyval_acc+15
        lda polyval_acc+13
        eor polyval_reduce8_s14,x
        eor polyval_htable8_s14,y
        sta polyval_acc+14
        lda polyval_acc+12
        eor polyval_reduce8_s13,x
        eor polyval_htable8_s13,y
        sta polyval_acc+13
        lda polyval_acc+11
        eor polyval_reduce8_s12,x
        eor polyval_htable8_s12,y
        sta polyval_acc+12
        lda polyval_acc+10
        eor polyval_reduce8_s11,x
        eor polyval_htable8_s11,y
        sta polyval_acc+11
        lda polyval_acc+9
        eor polyval_reduce8_s10,x
        eor polyval_htable8_s10,y
        sta polyval_acc+10
        lda polyval_acc+8
        eor polyval_reduce8_s9,x
        eor polyval_htable8_s9,y
        sta polyval_acc+9
        lda polyval_acc+7
        eor polyval_reduce8_s8,x
        eor polyval_htable8_s8,y
        sta polyval_acc+8
        lda polyval_acc+6
        eor polyval_reduce8_s7,x
        eor polyval_htable8_s7,y
        sta polyval_acc+7
        lda polyval_acc+5
        eor polyval_reduce8_s6,x
        eor polyval_htable8_s6,y
        sta polyval_acc+6
        lda polyval_acc+4
        eor polyval_reduce8_s5,x
        eor polyval_htable8_s5,y
        sta polyval_acc+5
        lda polyval_acc+3
        eor polyval_reduce8_s4,x
        eor polyval_htable8_s4,y
        sta polyval_acc+4
        lda polyval_acc+2
        eor polyval_reduce8_s3,x
        eor polyval_htable8_s3,y
        sta polyval_acc+3
        lda polyval_acc+1
        eor polyval_reduce8_s2,x
        eor polyval_htable8_s2,y
        sta polyval_acc+2
        lda polyval_acc+0
        eor polyval_reduce8_s1,x
        eor polyval_htable8_s1,y
        sta polyval_acc+1
        lda polyval_reduce8_s0,x
        eor polyval_htable8_s0,y
        sta polyval_acc+0
.endmacro
...
.macro pv_inline_xor_htable8_x
        lda polyval_acc+0
        eor polyval_htable8_s0,x
        sta polyval_acc+0
        lda polyval_acc+1
        eor polyval_htable8_s1,x
        sta polyval_acc+1
        lda polyval_acc+2
        eor polyval_htable8_s2,x
        sta polyval_acc+2
        lda polyval_acc+3
        eor polyval_htable8_s3,x
        sta polyval_acc+3
        lda polyval_acc+4
        eor polyval_htable8_s4,x
        sta polyval_acc+4
        lda polyval_acc+5
        eor polyval_htable8_s5,x
        sta polyval_acc+5
        lda polyval_acc+6
        eor polyval_htable8_s6,x
        sta polyval_acc+6
        lda polyval_acc+7
        eor polyval_htable8_s7,x
        sta polyval_acc+7
        lda polyval_acc+8
        eor polyval_htable8_s8,x
        sta polyval_acc+8
        lda polyval_acc+9
        eor polyval_htable8_s9,x
        sta polyval_acc+9
        lda polyval_acc+10
        eor polyval_htable8_s10,x
        sta polyval_acc+10
        lda polyval_acc+11
        eor polyval_htable8_s11,x
        sta polyval_acc+11
        lda polyval_acc+12
        eor polyval_htable8_s12,x
        sta polyval_acc+12
        lda polyval_acc+13
        eor polyval_htable8_s13,x
        sta polyval_acc+13
        lda polyval_acc+14
        eor polyval_htable8_s14,x
        sta polyval_acc+14
        lda polyval_acc+15
        eor polyval_htable8_s15,x
        sta polyval_acc+15
.endmacro
...
polyval_multiply_core:
        ...
        ldy pv_mul_input+15
        lda polyval_htable8_s0,y
        sta polyval_acc+0
        lda polyval_htable8_s1,y
        sta polyval_acc+1
        lda polyval_htable8_s2,y
        sta polyval_acc+2
        lda polyval_htable8_s3,y
        sta polyval_acc+3
        lda polyval_htable8_s4,y
        sta polyval_acc+4
        lda polyval_htable8_s5,y
        sta polyval_acc+5
        lda polyval_htable8_s6,y
        sta polyval_acc+6
        lda polyval_htable8_s7,y
        sta polyval_acc+7
        lda polyval_htable8_s8,y
        sta polyval_acc+8
        lda polyval_htable8_s9,y
        sta polyval_acc+9
        lda polyval_htable8_s10,y
        sta polyval_acc+10
        lda polyval_htable8_s11,y
        sta polyval_acc+11
        lda polyval_htable8_s12,y
        sta polyval_acc+12
        lda polyval_htable8_s13,y
        sta polyval_acc+13
        lda polyval_htable8_s14,y
        sta polyval_acc+14
        lda polyval_htable8_s15,y
        sta polyval_acc+15

        ; --- bytes 14..0: fused shift+reduce+htable per iteration ---
        ldx polyval_acc+15
        ldy pv_mul_input+14
        pv_fused_shift_reduce_htable
        ldx polyval_acc+15
        ldy pv_mul_input+13
        pv_fused_shift_reduce_htable
        ldx polyval_acc+15
