...
|---|---|---|
| **S1** | **NOT MET, but moving: 6 open, down from 10.** JC-000 merged PR#88 and PR#92 on 2026-09-07, closing **#85, #86, #90, #91**. Verified on the merged tree: all four gates green, `lib-verify` carrying PR#92's new banner, and both fixes still able to FAIL — `make dist VERSION=v0.11.0` refuses a moved tree (exit 2, tracked files untouched) and the #90 mutation is caught (`left lib_version.o at 3 PREFIXED exports, expected 4`). Remaining: #87, #89, #93, #94, #95, #96 | **improving** |
