...
| c64-ChaCha20-Poly1305 | adopter | **v0.11.0 — settled; ONE open as of 2026-09-07 ~20:30** (#119, nothing invokes their seven verification gates. #117, #118, #122 and #126 all CLOSED — #122's §6.4 claim was retracted by its own author, #126's 60 B RESIDENT under-declaration closed COMPLETED with no comment) | verified at the tag with a §6g positive control. `lib_manifest.s` 5 macro invocations at v0.10.0 → **0** at v0.11.0, `src/lib/precalc_manifest.s` present. Both #108 members done: `poly1305_lib.s` went 11 `.export` lines → 2, moving out the 8 `APP_OWNED` §8.1/§8.3 names. Their release also corrects the five under-reporting footprint equates from #113 |
